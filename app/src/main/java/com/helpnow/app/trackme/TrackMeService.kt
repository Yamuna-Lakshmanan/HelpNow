package com.helpnow.app.trackme
...
import com.helpnow.app.trackme.TrackMePreferences
import java.util.concurrent.atomic.AtomicLong

/**
 * Foreground service for live location tracking. Updates every 30s, triggers check-in every 7 min.
 */
class TrackMeService : Service() {
    ...
    companion object {
        ...
        private const val CHECK_IN_INTERVAL_MS = 7 * 60 * 1000L
        private const val CHECK_IN_TIMEOUT_MS = 2 * 60 * 1000L
        const val ACTION_STOP = "com.helpnow.app.trackme.STOP"
        const val ACTION_SAFE = "com.helpnow.app.trackme.SAFE"
